...
return [
    ...
    */
    ...
    // Playground: die Kurzlinks und QR-Codes zeigen auf die oeffentliche Demo,
    // auch lokal. Ein QR-Code mit 127.0.0.1 darin waere auf dem Flyer tot.
    // Zum Durchklicken auf dem eigenen Rechner OFFERS_LINKS_BASE_URL setzen.
    'links' => [
        'prefix' => 'go',
        'base_url' => env('OFFERS_LINKS_BASE_URL', 'https://demo.adriangoldner.dev'),
    ],
