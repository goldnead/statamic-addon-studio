...
return [
    ...
    */
    ...
    // Das Demo faehrt fuenf Marken auf einer Domain, unterschieden durch das
    // erste Pfadsegment. Ohne diese Zuordnung liefert die oeffentliche Seite
    // gar nichts aus: der Scope faellt geschlossen aus, und ein Besucher hat
    // keine Sitzung, aus der eine Marke zu lesen waere.
    'paths' => [
        'chorwerkstatt' => 'chorwerkstatt',
        'halbmond' => 'halbmond',
        'lindhorst' => 'lindhorst',
    ...
    */
    ...
    // Im Schauraum gewollt, damit man ohne eigene Domain umschalten kann.
    'allow_query_override' => env('BRAND_CONTEXT_ALLOW_QUERY_OVERRIDE', true),
